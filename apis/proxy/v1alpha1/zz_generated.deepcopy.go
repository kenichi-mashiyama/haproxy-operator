...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodAntiAffinityRule) DeepCopyInto(out *PodAntiAffinityRule) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodAntiAffinityRule.
func (in *PodAntiAffinityRule) DeepCopy() *PodAntiAffinityRule {
	if in == nil {
		return nil
	}
	out := new(PodAntiAffinityRule)
